...
final class j implements C0353g {

    /* renamed from: a  reason: collision with root package name */
    public final /* synthetic */ int f18151a;

    /* renamed from: b  reason: collision with root package name */
    private final Object f18152b;
    ...
    public final boolean m(A a10, StringBuilder sb2) {
        switch (this.f18151a) {
            case 0:
                ...
                sb2.append(c10 < 0 ? "-" : "+");
                if (((TextStyle) this.f18152b) == TextStyle.FULL) {
                    a(sb2, abs);
                    sb2.append(':');
                    a(sb2, abs2);
                    if (abs3 == 0) {
                ...
                return true;
            default:
                sb2.append((String) this.f18152b);
                return true;
        }
    }
    ...
    public final int n(j$.time.format.x r12, java.lang.CharSequence r13, int r14) {
        /*
            r11 = this;
            int r0 = r11.f18151a
            switch(r0) {
        ...
        L_0x0031:
            int r7 = r7 + r3
            java.lang.Object r2 = r11.f18152b
            j$.time.format.TextStyle r2 = (j$.time.format.TextStyle) r2
        ...
        L_0x0109:
            ...
            java.lang.Object r0 = r11.f18152b
            r4 = r0
            ...
            goto L_0x012f
        L_0x0126:
            java.lang.Object r12 = r11.f18152b
        ...
        L_0x0130:
            ...
            throw r12
        */
        throw new UnsupportedOperationException("Method not decompiled: j$.time.format.j.n(j$.time.format.x, java.lang.CharSequence, int):int");
    }

    public final String toString() {
        switch (this.f18151a) {
            case 0:
                StringBuilder b10 = b.b("LocalizedOffset(");
                b10.append((TextStyle) this.f18152b);
                b10.append(")");
                return b10.toString();
            default:
                String replace = ((String) this.f18152b).replace("'", "''");
                return "'" + replace + "'";
        }
    }
}
