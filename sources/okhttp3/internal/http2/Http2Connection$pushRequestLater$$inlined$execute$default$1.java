...
public final class Http2Connection$pushRequestLater$$inlined$execute$default$1 extends Task {
    ...
    public final /* synthetic */ Http2Connection f22440e;

    /* renamed from: f  reason: collision with root package name */
    public final /* synthetic */ int f22441f;

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ List f22442g;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public Http2Connection$pushRequestLater$$inlined$execute$default$1(String str, Http2Connection http2Connection, int i10, List list) {
        super(str, true);
        this.f22440e = http2Connection;
        this.f22441f = i10;
        this.f22442g = list;
    }
    ...
    public final long a() {
        /*
            r3 = this;
            okhttp3.internal.http2.Http2Connection r0 = r3.f22440e
            okhttp3.internal.http2.PushObserver r0 = r0.f22415s
            java.util.List r1 = r3.f22442g
            ...
            sk.j.f(r1, r0)
            okhttp3.internal.http2.Http2Connection r0 = r3.f22440e     // Catch:{ IOException -> 0x0030 }
            okhttp3.internal.http2.Http2Writer r0 = r0.F     // Catch:{ IOException -> 0x0030 }
            int r1 = r3.f22441f     // Catch:{ IOException -> 0x0030 }
            ...
            okhttp3.internal.http2.Http2Connection r1 = r3.f22440e     // Catch:{ all -> 0x002d }
            java.util.LinkedHashSet r1 = r1.H     // Catch:{ all -> 0x002d }
            int r2 = r3.f22441f     // Catch:{ all -> 0x002d }
        ...
        L_0x0030:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.http2.Http2Connection$pushRequestLater$$inlined$execute$default$1.a():long");
    }
}
