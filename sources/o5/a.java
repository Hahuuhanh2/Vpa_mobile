...
public final class a {
    ...
    public static final AtomicReference<byte[]> f13728a = new AtomicReference<>();
    ...
    public static java.nio.MappedByteBuffer a(java.io.File r9) {
        ...
        L_0x0057:
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: o5.a.a(java.io.File):java.nio.MappedByteBuffer");
    }

    public static ByteBuffer b(InputStream inputStream) {
        ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream(16384);
        byte[] andSet = f13728a.getAndSet((Object) null);
        if (andSet == null) {
    ...
    public static void c(java.nio.ByteBuffer r4, java.io.File r5) {
        ...
        L_0x0034:
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: o5.a.c(java.nio.ByteBuffer, java.io.File):void");
    }

    /* renamed from: o5.a$a  reason: collision with other inner class name */
    /* compiled from: ByteBufferUtil */
    public static class C0170a extends InputStream {

        /* renamed from: a  reason: collision with root package name */
        public final ByteBuffer f13729a;

        /* renamed from: b  reason: collision with root package name */
        public int f13730b = -1;

        public C0170a(ByteBuffer byteBuffer) {
            this.f13729a = byteBuffer;
        }

        public final int available() {
            return this.f13729a.remaining();
        }

        public final synchronized void mark(int i10) {
            this.f13730b = this.f13729a.position();
        }
        ...
        public final int read() {
            if (!this.f13729a.hasRemaining()) {
                return -1;
            }
            return this.f13729a.get() & 255;
        }

        public final synchronized void reset() {
            int i10 = this.f13730b;
            if (i10 != -1) {
                this.f13729a.position(i10);
            } else {
        ...
        public final long skip(long j10) {
            ...
            ByteBuffer byteBuffer = this.f13729a;
