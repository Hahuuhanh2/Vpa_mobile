...
public final class R$styleable {
    ...
    public static final int[] SingleDateAndTimePicker = {R$attr.picker_curved, R$attr.picker_curvedMaxAngle, R$attr.picker_cyclic, R$attr.picker_dayCount, R$attr.picker_displayDays, R$attr.picker_displayDaysOfMonth, R$attr.picker_displayHours, R$attr.picker_displayMinutes, R$attr.picker_displayMonth, R$attr.picker_displayMonthNumbers, R$attr.picker_displayYears, R$attr.picker_itemSpacing, R$attr.picker_monthFormat, R$attr.picker_mustBeOnFuture, R$attr.picker_selectedTextColor, R$attr.picker_selectorColor, R$attr.picker_selectorHeight, R$attr.picker_stepSizeHours, R$attr.picker_stepSizeMinutes, R$attr.picker_textAlign, R$attr.picker_textColor, R$attr.picker_textSize, R$attr.picker_todayText, R$attr.picker_visibleItemCount};
    public static final int SingleDateAndTimePicker_picker_curved = 0;
    public static final int SingleDateAndTimePicker_picker_curvedMaxAngle = 1;
    public static final int SingleDateAndTimePicker_picker_cyclic = 2;
    public static final int SingleDateAndTimePicker_picker_dayCount = 3;
    public static final int SingleDateAndTimePicker_picker_displayDays = 4;
    public static final int SingleDateAndTimePicker_picker_displayDaysOfMonth = 5;
    public static final int SingleDateAndTimePicker_picker_displayHours = 6;
    public static final int SingleDateAndTimePicker_picker_displayMinutes = 7;
    public static final int SingleDateAndTimePicker_picker_displayMonth = 8;
    public static final int SingleDateAndTimePicker_picker_displayMonthNumbers = 9;
    public static final int SingleDateAndTimePicker_picker_displayYears = 10;
    public static final int SingleDateAndTimePicker_picker_itemSpacing = 11;
    public static final int SingleDateAndTimePicker_picker_monthFormat = 12;
    public static final int SingleDateAndTimePicker_picker_mustBeOnFuture = 13;
    public static final int SingleDateAndTimePicker_picker_selectedTextColor = 14;
    public static final int SingleDateAndTimePicker_picker_selectorColor = 15;
    public static final int SingleDateAndTimePicker_picker_selectorHeight = 16;
    public static final int SingleDateAndTimePicker_picker_stepSizeHours = 17;
    public static final int SingleDateAndTimePicker_picker_stepSizeMinutes = 18;
    public static final int SingleDateAndTimePicker_picker_textAlign = 19;
    public static final int SingleDateAndTimePicker_picker_textColor = 20;
    public static final int SingleDateAndTimePicker_picker_textSize = 21;
    public static final int SingleDateAndTimePicker_picker_todayText = 22;
    public static final int SingleDateAndTimePicker_picker_visibleItemCount = 23;
