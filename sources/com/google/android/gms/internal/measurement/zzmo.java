...
final class zzmo {
    ...
    private static final Class<?> zzc = zzhr.zza();
    ...
    public static final class zza extends zzc {
        ...
        public final boolean zzc(Object obj, long j10) {
            if (zzmo.zza) {
                return zzmo.zzf(obj, j10);
            }
            return zzmo.zzg(obj, j10);
        }

        public final void zza(Object obj, long j10, boolean z10) {
            if (zzmo.zza) {
                zzmo.zzc(obj, j10, r3 ? (byte) 1 : 0);
            } else {
                zzmo.zzd(obj, j10, r3 ? (byte) 1 : 0);
            }
        }
    ...
    public static /* synthetic */ void zza(Throwable th2) {
        Logger logger = Logger.getLogger(zzmo.class.getName());
