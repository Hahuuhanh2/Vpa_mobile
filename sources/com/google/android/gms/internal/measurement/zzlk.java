...
interface zzlk {
    ...
    <T> void zza(T t10, zzlj<T> zzlj, zzis zzis);

    void zza(List<Boolean> list);

    @Deprecated
    <T> void zza(List<T> list, zzlj<T> zzlj, zzis zzis);

    <K, V> void zza(Map<K, V> map, zzkm<K, V> zzkm, zzis zzis);

    float zzb();

    <T> void zzb(T t10, zzlj<T> zzlj, zzis zzis);

    void zzb(List<zzhu> list);

    <T> void zzb(List<T> list, zzlj<T> zzlj, zzis zzis);
