...
final class zzmt extends zzmq {
    public final int zza(String str, byte[] bArr, int i10, int i11) {
        ...
        int i15 = i11 + i10;
        int i16 = 0;
        while (i16 < length && (i14 = i16 + i10) < i15 && (charAt = str.charAt(i16)) < 128) {
        ...
        while (i16 < length) {
            ...
            if (charAt2 < 128 && i17 < i15) {
                ...
                throw new zzms(i16 - 1, length);
            } else if (55296 > charAt2 || charAt2 > 57343 || ((i12 = i16 + 1) != str.length() && Character.isSurrogatePair(charAt2, str.charAt(i12)))) {
                throw new ArrayIndexOutOfBoundsException("Failed writing " + charAt2 + " at index " + i17);
            } else {
                throw new zzms(i16, length);
            }
            i17 = i13;
            i16++;
        }
