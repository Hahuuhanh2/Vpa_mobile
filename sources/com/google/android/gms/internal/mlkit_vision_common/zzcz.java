...
final class zzcz implements c {
    ...
    static {
        ...
        zzb = new b("cameraSource", b0.z(hashMap));
        zzai i11 = a.i(2);
        ...
        zzd = new b("requestedPreviewHeight", b0.z(hashMap3));
        zzai i13 = a.i(4);
        HashMap hashMap4 = new HashMap();
        hashMap4.put(i13.annotationType(), i13);
        zze = new b("requestedPreviewWidth", b0.z(hashMap4));
        zzai i14 = a.i(5);
        HashMap hashMap5 = new HashMap();
        hashMap5.put(i14.annotationType(), i14);
        zzf = new b("actualPreviewHeight", b0.z(hashMap5));
        zzai i15 = a.i(6);
        HashMap hashMap6 = new HashMap();
        hashMap6.put(i15.annotationType(), i15);
        zzg = new b("actualPreviewWidth", b0.z(hashMap6));
    }
