...
public final class zzu {
    public static int zza(int i10, int i11, String str) {
        ...
        if (i10 < 0) {
            str2 = zzac.zzb("%s (%s) must not be negative", "index", Integer.valueOf(i10));
        } else if (i11 < 0) {
            throw new IllegalArgumentException(a.m("negative size: ", i11));
        } else {
            str2 = zzac.zzb("%s (%s) must be less than size (%s)", "index", Integer.valueOf(i10), Integer.valueOf(i11));
        }
