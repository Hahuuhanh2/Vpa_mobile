...
final class zzamd {
    ...
    public static void zzA(int i10, List list, zzajt zzajt, boolean z10) {
        if (list != null && !list.isEmpty()) {
            zzajt.zzu(i10, list, z10);
        }
    }

    public static void zzB(int i10, List list, zzajt zzajt, boolean z10) {
        if (list != null && !list.isEmpty()) {
            zzajt.zzx(i10, list, z10);
        }
    }

    public static void zzC(int i10, List list, zzajt zzajt, boolean z10) {
        if (list != null && !list.isEmpty()) {
            zzajt.zzz(i10, list, z10);
        }
    }

    public static void zzD(int i10, List list, zzajt zzajt, boolean z10) {
        if (list != null && !list.isEmpty()) {
            zzajt.zzB(i10, list, z10);
        }
    }

    public static void zzE(int i10, List list, zzajt zzajt, boolean z10) {
        if (list != null && !list.isEmpty()) {
            zzajt.zzD(i10, list, z10);
        }
    }

    public static void zzF(int i10, List list, zzajt zzajt, boolean z10) {
        if (list != null && !list.isEmpty()) {
            zzajt.zzI(i10, list, z10);
        }
    }

    public static void zzG(int i10, List list, zzajt zzajt, boolean z10) {
        if (list != null && !list.isEmpty()) {
    ...
    public static int zzh(int i10, Object obj, zzamb zzamb) {
        int i11 = i10 << 3;
    ...
    public static Object zzo(Object obj, int i10, List list, zzako zzako, Object obj2, zzamv zzamv) {
        if (zzako == null) {
            return obj2;
        }
    ...
    public static Object zzp(Object obj, int i10, int i11, Object obj2, zzamv zzamv) {
        if (obj2 == null) {
            obj2 = zzamv.zzc(obj);
        }
    ...
    public static void zzq(zzamv zzamv, Object obj, Object obj2) {
    ...
    public static void zzt(int i10, List list, zzajt zzajt, boolean z10) {
        if (list != null && !list.isEmpty()) {
            zzajt.zzc(i10, list, z10);
        }
    }

    public static void zzu(int i10, List list, zzajt zzajt, boolean z10) {
        if (list != null && !list.isEmpty()) {
            zzajt.zzg(i10, list, z10);
        }
    }

    public static void zzv(int i10, List list, zzajt zzajt, boolean z10) {
        if (list != null && !list.isEmpty()) {
            zzajt.zzj(i10, list, z10);
        }
    }

    public static void zzw(int i10, List list, zzajt zzajt, boolean z10) {
        if (list != null && !list.isEmpty()) {
            zzajt.zzl(i10, list, z10);
        }
    }

    public static void zzx(int i10, List list, zzajt zzajt, boolean z10) {
        if (list != null && !list.isEmpty()) {
            zzajt.zzn(i10, list, z10);
        }
    }

    public static void zzy(int i10, List list, zzajt zzajt, boolean z10) {
        if (list != null && !list.isEmpty()) {
            zzajt.zzp(i10, list, z10);
        }
    }

    public static void zzz(int i10, List list, zzajt zzajt, boolean z10) {
        if (list != null && !list.isEmpty()) {
