...
public final class zzcq {
    ...
    @Deprecated
    public static zzbo zza(String str) {
        return ((zzbt) zzc.get()).zzb(str);
    }

    public static synchronized zzwi zzb(zzwn zzwn) {
        zzwi zza2;
    ...
    public static Object zzd(zzwi zzwi, Class cls) {
        return zze(zzwi.zzf(), zzwi.zze(), cls);
    }

    public static Object zze(String str, zzajf zzajf, Class cls) {
        return ((zzbt) zzc.get()).zza(str, cls).zzb(zzajf);
    }

    public static synchronized void zzf(zzon zzon, zzng zzng, boolean z10) {
        synchronized (zzcq.class) {
    ...
    public static synchronized void zzg(zzng zzng, boolean z10) {
        synchronized (zzcq.class) {
            AtomicReference atomicReference = zzc;
            zzbt zzbt = new zzbt((zzbt) atomicReference.get());
            zzbt.zzd(zzng);
    ...
    public static synchronized void zzh(zzcm zzcm) {
        synchronized (zzcq.class) {
            zznq.zza().zzf(zzcm);
        }
    }

    private static synchronized void zzi(String str, Map map, boolean z10) {
        synchronized (zzcq.class) {
            if (z10) {
                ConcurrentMap concurrentMap = zze;
    ...
    private static void zzj(Map map) {
        for (Map.Entry entry : map.entrySet()) {
