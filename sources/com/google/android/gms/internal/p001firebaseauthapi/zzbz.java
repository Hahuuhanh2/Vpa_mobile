...
public final class zzbz {
    ...
    private final synchronized zzwu zzh(zzwi zzwi, zzxo zzxo) {
        zzwt zzc;
        int zzg = zzg();
    ...
    private final synchronized zzwu zzi(zzwn zzwn) {
    ...
    public final synchronized int zza(zzwn zzwn, boolean z10) {
        zzwu zzi;
        zzws zzws = this.zza;
        zzi = zzi(zzwn);
        zzws.zzb(zzi);
    ...
    public final synchronized zzbz zzc(zzbv zzbv) {
        zza(zzbv.zzb(), false);
        return this;
    }
