...
public final class zzym {
    ...
    public static BigInteger zzb(BigInteger bigInteger, boolean z10, EllipticCurve ellipticCurve) {
    ...
    public static void zzd(ECPublicKey eCPublicKey, ECPrivateKey eCPrivateKey) {
    ...
    public static byte[] zzf(ECPrivateKey eCPrivateKey, ECPublicKey eCPublicKey) {
        zze(eCPublicKey, eCPrivateKey);
        ECPoint w9 = eCPublicKey.getW();
        zzmq.zzf(w9, eCPrivateKey.getParams().getCurve());
        PublicKey generatePublic = ((KeyFactory) zzyv.zzg.zza("EC")).generatePublic(new ECPublicKeySpec(w9, eCPrivateKey.getParams()));
    ...
    public static ECPrivateKey zzg(int i10, byte[] bArr) {
        return (ECPrivateKey) ((KeyFactory) zzyv.zzg.zza("EC")).generatePrivate(new ECPrivateKeySpec(zzmn.zza(bArr), zzi(i10)));
    }

    public static ECPublicKey zzh(ECParameterSpec eCParameterSpec, int i10, byte[] bArr) {
    ...
    public static ECParameterSpec zzi(int i10) {
        int i11 = i10 - 1;
        if (i11 == 0) {
            return zzmq.zza;
        }
    ...
    public static ECPoint zzj(EllipticCurve ellipticCurve, int i10, byte[] bArr) {
