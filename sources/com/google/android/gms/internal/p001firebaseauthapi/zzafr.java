...
final class zzafr extends BroadcastReceiver {
    ...
    public final void onReceive(Context context, Intent intent) {
        ...
        if ("com.google.android.gms.auth.api.phone.SMS_RETRIEVED".equals(intent.getAction())) {
            ...
            if (((Status) extras.get("com.google.android.gms.auth.api.phone.EXTRA_STATUS")).f5345a == 0) {
                ...
                if (zzafs == null) {
                    zzaft.zza.a("Verification code received with no active retrieval session.", new Object[0]);
                } else {
                    ...
                    zzafs.zze = str;
                    if (str == null) {
                        zzaft.zza.a("Unable to extract verification code.", new Object[0]);
