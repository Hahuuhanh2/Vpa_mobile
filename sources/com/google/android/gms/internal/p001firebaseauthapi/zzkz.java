...
public final class zzkz extends zzli {
    ...
    public static zzkz zzb(zzkq zzkq, zzzo zzzo, Integer num) {
        zzzo zzzo2;
        EllipticCurve ellipticCurve;
        zzko zzf = zzkq.zzf();
        zzko zzko = zzko.zzc;
        if (!zzf.equals(zzko) && num == null) {
            throw new GeneralSecurityException(b0.s("'idRequirement' must be non-null for ", zzf.toString(), " variant."));
            ...
            if (zzf2 == zzko) {
                ...
                zzzo2 = a.f(num, ByteBuffer.allocate(5).put((byte) 0));
            } else if (zzf2 == zzko.zza) {
                zzzo2 = a.f(num, ByteBuffer.allocate(5).put((byte) 1));
            } else {
