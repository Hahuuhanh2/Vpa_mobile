...
public final class zzxm extends zzakk implements zzalq {
    ...
    public static zzxm zze(zzajf zzajf, zzajx zzajx) {
        return (zzxm) zzakk.zzx(zzb, zzajf, zzajx);
    }

    public static /* synthetic */ void zzg(zzxm zzxm, String str) {
        str.getClass();
        zzxm.zze = str;
    }

    public static /* synthetic */ void zzh(zzxm zzxm, zzwn zzwn) {
        zzwn.getClass();
        zzxm.zzf = zzwn;
        zzxm.zzd |= 1;
    }
