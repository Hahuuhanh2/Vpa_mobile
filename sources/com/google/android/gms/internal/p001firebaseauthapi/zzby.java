...
public final class zzby {
    ...
    public static final zzby zza(zzwv zzwv) {
        zzl(zzwv);
        return new zzby(zzwv, zzk(zzwv));
    }

    public static final zzby zzh(zzbe zzbe, zzbd zzbd) {
    ...
    private static Object zzj(zzmw zzmw, zzwu zzwu, Class cls) {
        try {
    ...
    private static void zzl(zzwv zzwv) {
        if (zzwv == null || zzwv.zza() <= 0) {
            throw new GeneralSecurityException("empty keyset");
        }
    }

    private static final Object zzm(zzmw zzmw, zzbn zzbn, Class cls) {
        try {
            ...
            for (zzwu zzwu : zzwv.zzh()) {
                ...
                if (zzb2.zzb() == zzwh.ASYMMETRIC_PRIVATE) {
                    ...
                    if (zza2 instanceof zzcn) {
                        ...
                        throw new GeneralSecurityException(b0.s("manager for key type ", zzf, " is not a PrivateKeyManager"));
                    }
                } else {
    ...
    public final Object zze(zzbh zzbh, Class cls) {
        Object obj;
        boolean z10;
    ...
    public final void zzf(zzca zzca, zzbd zzbd) {
        zzwv zzwv = this.zza;
        byte[] bArr = new byte[0];
    ...
    public final void zzg(com.google.android.gms.internal.p001firebaseauthapi.zzca r5) {
        /*
            r4 = this;
        ...
        L_0x000a:
            ...
            com.google.android.gms.internal.firebase-auth-api.zzwu r1 = (com.google.android.gms.internal.p001firebaseauthapi.zzwu) r1
            ...
            com.google.android.gms.internal.firebase-auth-api.zzwh r3 = com.google.android.gms.internal.p001firebaseauthapi.zzwh.UNKNOWN_KEYMATERIAL
            if (r2 == r3) goto L_0x003b
            com.google.android.gms.internal.firebase-auth-api.zzwi r2 = r1.zzb()
            com.google.android.gms.internal.firebase-auth-api.zzwh r2 = r2.zzb()
            com.google.android.gms.internal.firebase-auth-api.zzwh r3 = com.google.android.gms.internal.p001firebaseauthapi.zzwh.SYMMETRIC
            if (r2 == r3) goto L_0x003b
            com.google.android.gms.internal.firebase-auth-api.zzwi r2 = r1.zzb()
            com.google.android.gms.internal.firebase-auth-api.zzwh r2 = r2.zzb()
            com.google.android.gms.internal.firebase-auth-api.zzwh r3 = com.google.android.gms.internal.p001firebaseauthapi.zzwh.ASYMMETRIC_PRIVATE
            if (r2 == r3) goto L_0x003b
            goto L_0x000a
        L_0x003b:
