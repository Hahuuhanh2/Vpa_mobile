...
public final class zzmv {
    ...
    public static void zzb(long[] r56, long[] r57, long[] r58) {
        /*
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p001firebaseauthapi.zzmv.zzb(long[], long[], long[]):void");
    }
    ...
    public static void zzg(long[] jArr, long[] jArr2) {
        ...
        long j24 = jArr2[7];
        long j25 = (j16 * j20) + (j12 * j24);
        long j26 = j25 + j25 + (j14 * j22) + (jArr2[8] * j11);
        long j27 = j26 + j26;
        long j28 = jArr2[8];
        long j29 = (j18 * j20) + (j16 * j22) + (j14 * j24) + (j12 * j28) + (j11 * jArr2[9]);
        long j30 = jArr2[9];
        long j31 = (j12 * j30) + (j16 * j24);
        long j32 = j31 + j31;
        long j33 = j32 + (j20 * j20) + (j18 * j22) + (j14 * j28);
        long j34 = (j20 * j22) + (j18 * j24) + (j16 * j28) + (j14 * j30);
        long j35 = (j16 * j30) + (j20 * j24);
        long j36 = j35 + j35 + (j18 * j28);
        long j37 = (j22 * j24) + (j20 * j28) + (j18 * j30);
        long j38 = (j24 * j24) + (j22 * j28) + ((j20 + j20) * j30);
        long j39 = (j22 * j30) + (j24 * j28);
        zzc(new long[]{j10 * j10, (j11 + j11) * jArr2[1], j13 + j13, j15 + j15, j17 + ((j11 + j11) * jArr2[4]), j19 + j19, j21 + j21, j23 + j23, j27 + (j18 * j18), j29 + j29, j33 + j33, j34 + j34, j36 + j36 + (j22 * j22), j37 + j37, j38 + j38, j39 + j39, (j24 * 4 * j30) + (j28 * j28), (j28 + j28) * j30, (j30 + j30) * j30}, jArr);
    }
    ...
    public static byte[] zzj(long[] jArr) {
        ...
        long j16 = (((long) ((int) (j15 >> 25))) * 19) + copyOf[0];
        copyOf[0] = j16;
