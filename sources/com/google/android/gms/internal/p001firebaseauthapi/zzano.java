...
public final class zzano {
    ...
    public static zzamt zzb(String str) {
        String str2;
        int i10;
            ...
            if (indexOf2 != -1) {
                ...
                if (str.charAt(indexOf2) != 'Z') {
                    ...
                    if (indexOf4 != -1) {
                        ...
                        long parseLong = Long.parseLong(substring3.substring(indexOf4 + 1));
                        char charAt = str.charAt(indexOf2);
                        long parseLong2 = (parseLong + (Long.parseLong(substring4) * 60)) * 60;
                        if (charAt == '+') {
                            time -= parseLong2;
                        } else {
                            time += parseLong2;
                    ...
                    throw new ParseException(b0.s("Failed to parse timestamp: invalid trailing data \"", str.substring(indexOf2), "\""), 0);
                }
                if (i10 <= -1000000000 || i10 >= 1000000000) {
                    try {
                        ...
                        ParseException parseException = new ParseException(b0.s("Failed to parse timestamp ", str, " Timestamp is out of range."), 0);
        ...
        throw new ParseException(b0.s("Failed to parse timestamp: invalid timestamp \"", str, "\""), 0);
    }
