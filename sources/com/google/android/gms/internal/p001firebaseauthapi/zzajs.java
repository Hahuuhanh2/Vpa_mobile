...
public abstract class zzajs extends zzaiv {
    ...
    public /* synthetic */ zzajs(zzajr zzajr) {
    }
    ...
    @Deprecated
    public static int zzw(int i10, zzalp zzalp, zzamb zzamb) {
    ...
    public static int zzy(zzalp zzalp, zzamb zzamb) {
        int zzn = ((zzaip) zzalp).zzn(zzamb);
        return zzA(zzn) + zzn;
    }
    ...
    public final void zzE(String str, zzanj zzanj) {
    ...
    public abstract void zzL(int i10, zzajf zzajf);
    ...
    public abstract void zzn(int i10, zzalp zzalp, zzamb zzamb);
