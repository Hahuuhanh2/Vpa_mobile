...
final class zzds {
    ...
    public static void zzc(zznt zznt) {
        zznt.zzh(zzc);
        zznt.zzg(zzd);
        zznt.zzf(zze);
        zznt.zze(zzf);
    ...
    private static zzdk zzd(zzvc zzvc) {
        ...
        throw new GeneralSecurityException(a.m("Unable to parse HashType: ", zzvc.zza()));
    }

    private static zzdl zze(zzxo zzxo) {
        ...
        if (ordinal != 2) {
            ...
            if (ordinal != 4) {
                throw new GeneralSecurityException(a.m("Unable to parse OutputPrefixType: ", zzxo.zza()));
            }
        }
        return zzdl.zzb;
    }
