...
public final class zzjr {
    ...
    public /* synthetic */ zzjr(zzjq zzjq) {
        this.zza = null;
        this.zzb = null;
        this.zzc = null;
        this.zzd = null;
    ...
    public final zzjr zzb(zzce zzce) {
        if (zzjx.zza.contains(zzce)) {
            this.zzd = zzce;
            return this;
        }
        throw new GeneralSecurityException(b0.s("Invalid DEM parameters ", zzce.toString(), "; only AES128_GCM_RAW, AES256_GCM_RAW, AES128_CTR_HMAC_SHA256_RAW, AES256_CTR_HMAC_SHA256_RAW XCHACHA20_POLY1305_RAW and AES256_SIV_RAW are currently supported."));
    }
