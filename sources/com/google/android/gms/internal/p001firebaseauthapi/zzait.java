...
final class zzait {
    public static int zza(byte[] bArr, int i10, zzais zzais) {
    ...
    public static int zzc(zzamb zzamb, byte[] bArr, int i10, int i11, int i12, zzais zzais) {
    ...
    public static int zzd(zzamb zzamb, byte[] bArr, int i10, int i11, zzais zzais) {
        Object zze = zzamb.zze();
    ...
    public static int zze(zzamb zzamb, int i10, byte[] bArr, int i11, int i12, zzakp zzakp, zzais zzais) {
    ...
    public static int zzf(byte[] bArr, int i10, zzakp zzakp, zzais zzais) {
    ...
    public static int zzg(int i10, byte[] bArr, int i11, int i12, zzamw zzamw, zzais zzais) {
        if ((i10 >>> 3) != 0) {
            int i13 = i10 & 7;
            if (i13 == 0) {
    ...
    public static int zzh(byte[] bArr, int i10, zzais zzais) {
        int i11 = i10 + 1;
        byte b10 = bArr[i10];
        if (b10 < 0) {
    ...
    public static int zzi(int i10, byte[] bArr, int i11, zzais zzais) {
        byte b10 = bArr[i11];
        int i12 = i11 + 1;
        int i13 = i10 & 127;
        if (b10 >= 0) {
    ...
    public static int zzj(int i10, byte[] bArr, int i11, int i12, zzakp zzakp, zzais zzais) {
        zzakl zzakl = (zzakl) zzakp;
        int zzh = zzh(bArr, i11, zzais);
        zzakl.zzf(zzais.zza);
        while (zzh < i12) {
    ...
    public static int zzk(byte[] bArr, int i10, zzais zzais) {
    ...
    public static int zzl(Object obj, zzamb zzamb, byte[] bArr, int i10, int i11, int i12, zzais zzais) {
    ...
    public static int zzm(java.lang.Object r6, com.google.android.gms.internal.p001firebaseauthapi.zzamb r7, byte[] r8, int r9, int r10, com.google.android.gms.internal.p001firebaseauthapi.zzais r11) {
        /*
            int r0 = r9 + 1
            byte r9 = r8[r9]
        ...
        L_0x000c:
            ...
            return r9
        L_0x001e:
            com.google.android.gms.internal.firebase-auth-api.zzaks r6 = com.google.android.gms.internal.p001firebaseauthapi.zzaks.zzj()
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p001firebaseauthapi.zzait.zzm(java.lang.Object, com.google.android.gms.internal.firebase-auth-api.zzamb, byte[], int, int, com.google.android.gms.internal.firebase-auth-api.zzais):int");
    }
