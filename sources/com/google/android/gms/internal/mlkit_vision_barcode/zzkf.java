...
final class zzkf implements c {
    ...
    static {
        ...
        zzd = new b("detectorOptions", b0.z(hashMap3));
        zzdk h13 = a.h(4);
        HashMap hashMap4 = new HashMap();
        hashMap4.put(h13.annotationType(), h13);
        zze = new b("loadDurationMs", b0.z(hashMap4));
        zzdk h14 = a.h(5);
        HashMap hashMap5 = new HashMap();
        hashMap5.put(h14.annotationType(), h14);
        zzf = new b("sessionDurationMs", b0.z(hashMap5));
        zzdk h15 = a.h(6);
        HashMap hashMap6 = new HashMap();
        hashMap6.put(h15.annotationType(), h15);
        zzg = new b("sessionTotalInferenceDurationMs", b0.z(hashMap6));
    }
