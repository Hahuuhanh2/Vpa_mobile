...
final class zzbq implements d {
    ...
    private static final c zzd = zzbp.zza;
    ...
    public zzbq(OutputStream outputStream, Map map, Map map2, c cVar) {
    ...
    private static int zzh(b bVar) {
        zzbo zzbo = (zzbo) bVar.a(zzbo.class);
        if (zzbo != null) {
            return zzbo.zza();
        }
    ...
    private static zzbo zzj(b bVar) {
        zzbo zzbo = (zzbo) bVar.a(zzbo.class);
        if (zzbo != null) {
            return zzbo;
        }
    ...
    private final zzbq zzk(c cVar, b bVar, Object obj, boolean z10) {
    ...
    private final zzbq zzl(e eVar, b bVar, Object obj, boolean z10) {
    ...
    public final zzbq zzd(b bVar, int i10, boolean z10) {
        if (z10 && i10 == 0) {
            return this;
        }
        zzbo zzj = zzj(bVar);
    ...
    public final zzbq zze(b bVar, long j10, boolean z10) {
        if (z10 && j10 == 0) {
            return this;
        }
        zzbo zzj = zzj(bVar);
