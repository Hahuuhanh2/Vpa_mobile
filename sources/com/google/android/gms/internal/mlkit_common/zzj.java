...
public final class zzj {
    ...
    public static InputStream zzb(Context context, Uri uri, zzi zzi) {
        ContentResolver contentResolver = context.getContentResolver();
        Uri zzc2 = zzc(uri);
        String scheme = zzc2.getScheme();
        if ("android.resource".equals(scheme)) {
    ...
    private static void zzh(android.content.Context r7, android.os.ParcelFileDescriptor r8, android.net.Uri r9, com.google.android.gms.internal.mlkit_common.zzi r10) {
        /*
            ...
            java.io.File r8 = k1.a.getDataDir(r7)
            r0 = 0
            r1 = 1
        ...
        L_0x0057:
            ...
            goto L_0x0054
        L_0x0066:
            android.content.Context r8 = k1.a.createDeviceProtectedStorageContext(r7)
            if (r8 == 0) goto L_0x007d
            java.io.File r8 = k1.a.getDataDir(r8)
            if (r8 == 0) goto L_0x007d
            java.lang.String r8 = zze(r8)
            boolean r8 = r9.startsWith(r8)
            if (r8 == 0) goto L_0x007d
