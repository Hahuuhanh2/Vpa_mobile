...
final class zzio implements c {
    ...
    static {
        ...
        zzd = new b("inputLength", b0.z(hashMap3));
        zzbo g12 = a.g(4);
        HashMap hashMap4 = new HashMap();
        hashMap4.put(g12.annotationType(), g12);
        zze = new b("outputLength", b0.z(hashMap4));
        zzbo g13 = a.g(5);
        HashMap hashMap5 = new HashMap();
        hashMap5.put(g13.annotationType(), g13);
        zzf = new b("loadDictionaryErrorCode", b0.z(hashMap5));
        zzbo g14 = a.g(6);
        HashMap hashMap6 = new HashMap();
        hashMap6.put(g14.annotationType(), g14);
        zzg = new b("translateResultStatusCode", b0.z(hashMap6));
        zzbo g15 = a.g(7);
        ...
        zzi = new b("downloadHttpResponseCode", b0.z(hashMap8));
    }
