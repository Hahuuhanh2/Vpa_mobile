...
public final class zzgx {
    ...
    public static void zzd(int i10, int i11, int i12) {
        ...
        if (i10 < 0 || i11 < i10 || i11 > i12) {
            if (i10 < 0 || i10 > i12) {
                ...
                str = zzha.zza("end index (%s) must not be less than start index (%s)", Integer.valueOf(i11), Integer.valueOf(i10));
            }
    ...
    private static String zzf(int i10, int i11, String str) {
        if (i10 < 0) {
            return zzha.zza("%s (%s) must not be negative", str, Integer.valueOf(i10));
        }
        return zzha.zza("%s (%s) must not be greater than size (%s)", str, Integer.valueOf(i10), Integer.valueOf(i11));
    }
}
