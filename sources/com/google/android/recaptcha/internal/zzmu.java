...
class zzmu extends AbstractMap {
    ...
    public /* synthetic */ zzmu(int i10, zzmt zzmt) {
        this.zza = i10;
    }
    ...
    private final int zzk(Comparable comparable) {
        ...
        int i10 = 0;
        if (size >= 0) {
            int compareTo = comparable.compareTo(((zzmo) this.zzb.get(size)).zza());
            if (compareTo > 0) {
                return -(size + 2);
            }
            if (compareTo == 0) {
        ...
        while (i10 <= size) {
            int i11 = (i10 + size) / 2;
            int compareTo2 = comparable.compareTo(((zzmo) this.zzb.get(i11)).zza());
            if (compareTo2 < 0) {
                size = i11 - 1;
    ...
    public final Set entrySet() {
        if (this.zze == null) {
            this.zze = new zzms(this, (zzmr) null);
        }
        return this.zze;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        int zzb2 = zzb();
        if (zzb2 != zzmu.zzb()) {
            return entrySet().equals(zzmu.entrySet());
        }
        for (int i10 = 0; i10 < zzb2; i10++) {
            if (!zzg(i10).equals(zzmu.zzg(i10))) {
                return false;
            }
        }
        if (zzb2 != size) {
            return this.zzc.equals(zzmu.zzc);
        }
        return true;
    }
    ...
    public final Object get(Object obj) {
        ...
        if (zzk >= 0) {
            return ((zzmo) this.zzb.get(zzk)).getValue();
        }
    ...
    public final int hashCode() {
        ...
        for (int i11 = 0; i11 < zzb2; i11++) {
            i10 += ((zzmo) this.zzb.get(i11)).hashCode();
        }
        if (this.zzc.size() > 0) {
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i11 = this.zza;
        if (size == i11) {
            zzmo zzmo = (zzmo) this.zzb.remove(i11 - 1);
            zzm().put(zzmo.zza(), zzmo.getValue());
        }
