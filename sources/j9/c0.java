...
public final class c0 {
    ...
    public static final Unsafe f11741a;

    /* renamed from: b  reason: collision with root package name */
    public static final Class<?> f11742b = a.f11727a;

    /* renamed from: c  reason: collision with root package name */
    public static final e f11743c;

    /* renamed from: d  reason: collision with root package name */
    public static final boolean f11744d;

    /* renamed from: e  reason: collision with root package name */
    public static final boolean f11745e;

    /* renamed from: f  reason: collision with root package name */
    public static final long f11746f = ((long) c(byte[].class));

    /* renamed from: g  reason: collision with root package name */
    public static final boolean f11747g;
    ...
    public static final class b extends e {
        ...
        public final void k(Object obj, long j10, boolean z10) {
            if (c0.f11747g) {
                c0.s(obj, j10, z10 ? (byte) 1 : 0);
            } else {
                c0.t(obj, j10, z10 ? (byte) 1 : 0);
            }
        }
    ...
    public static final class d extends e {
        ...
        public final boolean c(Object obj, long j10) {
            return this.f11748a.getBoolean(obj, j10);
        }

        public final byte d(Object obj, long j10) {
            return this.f11748a.getByte(obj, j10);
        }

        public final double e(Object obj, long j10) {
            return this.f11748a.getDouble(obj, j10);
        }

        public final float f(Object obj, long j10) {
            return this.f11748a.getFloat(obj, j10);
        }

        public final void k(Object obj, long j10, boolean z10) {
            this.f11748a.putBoolean(obj, j10, z10);
        }

        public final void l(Object obj, long j10, byte b10) {
            this.f11748a.putByte(obj, j10, b10);
        }

        public final void m(Object obj, long j10, double d10) {
            this.f11748a.putDouble(obj, j10, d10);
        }

        public final void n(Object obj, long j10, float f10) {
            this.f11748a.putFloat(obj, j10, f10);
        }
        ...
        public final boolean r() {
            ...
            try {
                Class<?> cls2 = this.f11748a.getClass();
        ...
        public final boolean s() {
            /*
                ...
                sun.misc.Unsafe r2 = r11.f11748a
            ...
            L_0x000f:
                ...
                java.lang.reflect.Field r2 = j9.c0.e()     // Catch:{ all -> 0x0032 }
            ...
            L_0x0037:
                ...
                return r6
            L_0x003a:
                sun.misc.Unsafe r2 = r11.f11748a     // Catch:{ all -> 0x009e }
            ...
            L_0x009e:
                ...
                return r6
            */
            throw new UnsupportedOperationException("Method not decompiled: j9.c0.d.s():boolean");
        }
    }
    ...
    public static abstract class e {
        ...
        public final int a(Class<?> cls) {
            return this.f11748a.arrayBaseOffset(cls);
        }

        public final int b(Class<?> cls) {
            return this.f11748a.arrayIndexScale(cls);
        }
        ...
        public final int g(Object obj, long j10) {
            return this.f11748a.getInt(obj, j10);
        }

        public final long h(Object obj, long j10) {
            return this.f11748a.getLong(obj, j10);
        }

        public final Object i(Object obj, long j10) {
            return this.f11748a.getObject(obj, j10);
        }

        public final long j(Field field) {
            return this.f11748a.objectFieldOffset(field);
        }
        ...
        public final void o(Object obj, int i10, long j10) {
            this.f11748a.putInt(obj, j10, i10);
        }

        public final void p(Object obj, long j10, long j11) {
            this.f11748a.putLong(obj, j10, j11);
        }

        public final void q(Object obj, long j10, Object obj2) {
            this.f11748a.putObject(obj, j10, obj2);
        }

        public boolean r() {
            Class<Object> cls = Object.class;
            Unsafe unsafe = this.f11748a;
            if (unsafe == null) {
                return false;
            }
            try {
    ...
    static {
        /*
            ...
            f11741a = r6
            java.lang.Class<?> r7 = j9.a.f11727a
            f11742b = r7
        ...
        L_0x0025:
            ...
            j9.c0$c r7 = new j9.c0$c
            r7.<init>(r6)
            goto L_0x0042
        L_0x0033:
            if (r8 == 0) goto L_0x003b
            j9.c0$b r7 = new j9.c0$b
            r7.<init>(r6)
            goto L_0x0042
        L_0x003b:
            r7 = 0
        ...
        L_0x009b:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: j9.c0.<clinit>():void");
    }
    ...
    public static <T> T b(Class<T> cls) {
        try {
            return f11741a.allocateInstance(cls);
    ...
    public static boolean g(Object obj, long j10) {
        return f11743c.c(obj, j10);
    }

    public static byte h(byte[] bArr, long j10) {
        return f11743c.d(bArr, f11746f + j10);
    }
    ...
    public static void q(Object obj, long j10, boolean z10) {
        f11743c.k(obj, j10, z10);
    }

    public static void r(byte[] bArr, long j10, byte b10) {
        f11743c.l(bArr, f11746f + j10, b10);
    }
