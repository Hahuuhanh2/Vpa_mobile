...
@e(c = "com.vpa.daugia.module.auth.ui.viewmodel.LoginViewModel$recoverWithMail$1", f = "LoginViewModel.kt", l = {626}, m = "invokeSuspend")
/* compiled from: LoginViewModel.kt */
public final class j extends i implements p<d0, d<? super ek.i>, Object> {

    /* renamed from: a  reason: collision with root package name */
    public int f19142a;

    /* renamed from: b  reason: collision with root package name */
    public final /* synthetic */ LoginViewModel f19143b;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public j(LoginViewModel loginViewModel, d<? super j> dVar) {
        super(2, dVar);
        this.f19143b = loginViewModel;
    }

    public final d<ek.i> create(Object obj, d<?> dVar) {
        return new j(this.f19143b, dVar);
    }

    public final Object invoke(Object obj, Object obj2) {
        return ((j) create((d0) obj, (d) obj2)).invokeSuspend(ek.i.f20112a);
    }
    ...
    public final java.lang.Object invokeSuspend(java.lang.Object r19) {
        ...
        L_0x001d:
            p3.l0.Q0(r19)
            com.vpa.daugia.module.auth.ui.viewmodel.LoginViewModel r2 = r1.f19143b     // Catch:{ Exception -> 0x0012 }
        ...
        L_0x003a:
            ...
            java.lang.String r2 = r2.getEmail()     // Catch:{ Exception -> 0x0012 }
            r9 = r2
            goto L_0x004b
        L_0x004a:
            r9 = r4
        ...
        L_0x005c:
            ...
            com.vpa.daugia.module.auth.ui.viewmodel.LoginViewModel r5 = r1.f19143b     // Catch:{ Exception -> 0x0012 }
            com.vpa.daugia.module.auth.data.api.AuthApiHelper r5 = r5.f19546e     // Catch:{ Exception -> 0x0012 }
            r1.f19142a = r3     // Catch:{ Exception -> 0x0012 }
            java.lang.Object r2 = r5.recoverWithMail(r2, r1)     // Catch:{ Exception -> 0x0012 }
        ...
        L_0x0072:
            ...
            com.vpa.daugia.module.auth.ui.viewmodel.LoginViewModel r0 = r1.f19143b     // Catch:{ Exception -> 0x0012 }
        ...
        L_0x00a1:
            ...
            goto L_0x00ff
        L_0x00bd:
            com.vpa.daugia.module.auth.ui.viewmodel.LoginViewModel r2 = r1.f19143b
            r2.p<ze.f<java.lang.Object>> r2 = r2.B
            ze.f$a r3 = new ze.f$a
            boolean r5 = r0 instanceof retrofit2.HttpException     // Catch:{ Exception -> 0x00f8 }
            if (r5 == 0) goto L_0x00f9
            r5 = r0
            retrofit2.HttpException r5 = (retrofit2.HttpException) r5     // Catch:{ Exception -> 0x00f8 }
            ul.y<?> r5 = r5.f22764a     // Catch:{ Exception -> 0x00f8 }
            if (r5 == 0) goto L_0x00d6
            okhttp3.ResponseBody r5 = r5.f23248c     // Catch:{ Exception -> 0x00f8 }
            if (r5 == 0) goto L_0x00d6
            java.lang.String r4 = r5.q()     // Catch:{ Exception -> 0x00f8 }
        L_0x00d6:
            bc.h r5 = new bc.h     // Catch:{ Exception -> 0x00f9 }
            r5.<init>()     // Catch:{ Exception -> 0x00f9 }
            java.lang.Class<ef.k> r6 = ef.k.class
            java.lang.Object r4 = r5.d(r6, r4)     // Catch:{ Exception -> 0x00f9 }
            ef.k r4 = (ef.k) r4     // Catch:{ Exception -> 0x00f9 }
            java.lang.Exception r5 = new java.lang.Exception     // Catch:{ Exception -> 0x00f9 }
            java.util.List r4 = r4.c()     // Catch:{ Exception -> 0x00f9 }
            java.lang.Object r4 = fk.p.N0(r4)     // Catch:{ Exception -> 0x00f9 }
            java.lang.String r4 = (java.lang.String) r4     // Catch:{ Exception -> 0x00f9 }
