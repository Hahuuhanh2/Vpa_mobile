...
public final class b {
    ...
    /* compiled from: FocusStrategy */
    public static class C0047b<T> implements Comparator<T> {

        /* renamed from: a  reason: collision with root package name */
        public final Rect f4525a = new Rect();

        /* renamed from: b  reason: collision with root package name */
        public final Rect f4526b = new Rect();

        /* renamed from: c  reason: collision with root package name */
        public final boolean f4527c;

        /* renamed from: d  reason: collision with root package name */
        public final a<T> f4528d;

        public C0047b(boolean z10, a.C0046a aVar) {
            this.f4527c = z10;
            this.f4528d = aVar;
        }

        public final int compare(T t10, T t11) {
            Rect rect = this.f4525a;
            Rect rect2 = this.f4526b;
            ((a.C0046a) this.f4528d).getClass();
            ((f) t10).f(rect);
            ((a.C0046a) this.f4528d).getClass();
            ((f) t11).f(rect2);
            int i10 = rect.top;
    ...
    public static boolean a(int r9, android.graphics.Rect r10, android.graphics.Rect r11, android.graphics.Rect r12) {
        ...
        L_0x007d:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: c2.b.a(int, android.graphics.Rect, android.graphics.Rect, android.graphics.Rect):boolean");
    }
