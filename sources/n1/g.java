...
public final class g {
    public static boolean a(a[] aVarArr, a[] aVarArr2) {
        ...
        for (int i10 = 0; i10 < aVarArr.length; i10++) {
            a aVar = aVarArr[i10];
            char c10 = aVar.f13432a;
            a aVar2 = aVarArr2[i10];
            if (c10 != aVar2.f13432a || aVar.f13433b.length != aVar2.f13433b.length) {
                return false;
            }
        }
        return true;
    ...
    public static n1.g.a[] c(java.lang.String r17) {
        /*
            r0 = r17
        ...
        L_0x00bc:
            ...
            java.lang.String r4 = "\""
            java.lang.String r2 = f0.b0.s(r3, r2, r4)
            r1.<init>(r2, r0)
            throw r1
        L_0x00cb:
        ...
        L_0x00fc:
            int r0 = r1.size()
            n1.g$a[] r0 = new n1.g.a[r0]
            java.lang.Object[] r0 = r1.toArray(r0)
            n1.g$a[] r0 = (n1.g.a[]) r0
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: n1.g.c(java.lang.String):n1.g$a[]");
    }
    ...
    public static Path d(String str) {
        ...
        try {
            ...
            throw new RuntimeException(b0.r("Error in parsing ", str), e10);
        }
    }
    ...
    public static class a {
        ...
        public static void a(Path path, float f10, float f11, float f12, float f13, float f14, float f15, float f16, boolean z10, boolean z11) {
            ...
            if (d29 != 0.0d) {
                ...
                double d33 = d20 - d10;
                double d34 = sin;
                double atan2 = Math.atan2(d33, d17 - d11);
                ...
                double d35 = d11 * d16;
                double d36 = d10 * d19;
                double d37 = (d35 * cos) - (d36 * d34);
                double d38 = (d36 * cos) + (d35 * d34);
                ...
                while (i11 < ceil) {
                    ...
                    double d49 = d47;
                    double d50 = (((d16 * cos2) * cos4) + d37) - (d41 * sin4);
                    double d51 = d46;
                    double d52 = d37;
                    double d53 = (d51 * sin4) + (d16 * sin2 * cos4) + d38;
                    ...
                    path.cubicTo((float) ((d42 * sqrt3) + d15), (float) ((d45 * sqrt3) + d21), (float) (d50 - (sqrt3 * d54)), (float) (d53 - (sqrt3 * d55)), (float) d50, (float) d53);
                    i11++;
                    atan2 = d57;
                    d43 = d43;
                    cos2 = cos2;
        ...
        public static void b(a[] aVarArr, Path path) {
            ...
            while (i19 < aVarArr2.length) {
                a aVar = aVarArr2[i19];
                char c14 = aVar.f13432a;
                float[] fArr4 = aVar.f13433b;
                float f35 = fArr3[i18];
                float f36 = fArr3[1];
                float f37 = fArr3[2];
                float f38 = fArr3[3];
                    ...
                    if (c14 != 'A') {
                        if (c14 != 'C') {
                            if (c14 == 'H') {
                                ...
                                c11 = c14;
                                i14 = i19;
                                a(path, f63, f62, f64, f65, f66, f67, f69, z12, z13);
                                f12 = f63 + fArr2[i53];
                                f13 = f62 + fArr2[i54];
                            }
                            i20 = i11 + i10;
                        ...
                        a(path, f73, f72, f74, f75, f76, f77, f78, z10, z11);
                        f12 = fArr2[i59];
                        f13 = fArr2[i60];
                    }
                    f10 = f44;
                ...
                i17 = 6;
                c12 = 'm';
                c13 = aVarArr[i61].f13432a;
                aVarArr2 = aVarArr;
            }
        }

        public a(a aVar) {
            this.f13432a = aVar.f13432a;
            float[] fArr = aVar.f13433b;
            this.f13433b = g.b(fArr, fArr.length);
        }
    }
}
